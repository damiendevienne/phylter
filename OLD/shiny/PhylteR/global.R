...
# packages needed for PhylteR functions
require(FactoMineR)
require(DistatisR)
require(ape)
require(phangorn)

# All the functions in the global.R are functions from the PhylteR.R file from the PhylteR package exept the trees2trees() function.

# trees2trees permits to return le list of trees after nodes were collapsed.

trees2trees <- function(trees, bvalue = 0){
  list.trees <- list()
