...
Here is a brief introduction to the use **phylter** on a collection of gene trees. For more more detailed examples, please go to [ADD LINK TO THE AUTOMATICALLY GENERATED WEBSITEWEB](ADD LINK TO THE AUTOMATICALLY GENERATED WEBSITEWEB).
...
___
___
# END OF THE README. WHAT FOLLOWS SHOULD GO TO A VIGNETTE

- virer la table des matières ? Inutile sûrement avec la création automatique de page web. 
- mettre les figures et les fichiers ailleurs ? Je te laisse gérer Aurélie. 
**MERCI !!**
___
